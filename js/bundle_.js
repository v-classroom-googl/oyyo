...
! function() {
        ...
        var a = t("./scripts/views/ClearingView"),
            ...
            m = function() {
                ...
                return t.init = function() {
                    ...
                    }, t.width = 750, t.height = 1334, t.scaleMode = "fixedheight", t.screenMode = "none",
        ...
        var a = t("../LayaSample"),
            n = function(t) {
                function e() {
                    ...
                    return e.originMaxSpeed = .55, e.maxSpeed = .55, e.speedUpFactor = 1.28, e.jumpFactor = .1,
    ...
    8: [function(t, e, i) {
        ...
        var a = t("../LayaSample"),
            n = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e.originMaxSpeed = .59, e.maxSpeed = .59, e.speedUpFactor = 1.3, e.jumpFactor = .1,
                        e.gravity = -.25, e.accelerate = .02, e.acceTimer = 0, e.deceTimer = 1, e.speedZ = 0,
                        e.speedY = 0, e.currentHeight = .689, e.rotateTimer = 0, e.rotateAngle = 0, e.rotateStatus = 0,
                ...
                return __extends(e, t), e.prototype.init = function() {
                        this.hitName = "";
                        Laya.timer.clearAll(this), this.speedZ = 0, this.speedY = 0, this.acceTimer = 0,
                            this.deceTimer = 1, this.maxSpeed = .59, this.fixData(), this.isJump = !1, this.isSpeedUp = !1,
    ...
    11: [function(t, e, i) {
        ...
        var a = function() {
            function t() {
                this.bannerAdID = "", this.videoAdID = "",
    ...
    12: [function(t, e, i) {
        ...
        var a = function() {
            ...
            return Object.defineProperty(t.prototype, "isPlay", {
                ...
                set: function(t) {
                    this._isPause = t, Laya.timer.scale = t ? 0 : window.factor;
                },
                enumerable: !0,
                configurable: !0
        ...
        var a = t("../LayaSample"),
            n = function() {
                ...
                return t.prototype.init = function() {
                    ...
                    t.includes('bgm') ? Laya.SoundManager.playMusic(this._pathRoot + t + ".mp3") : Laya.SoundManager.playSound(this._pathRoot + t + ".mp3");
            ...
            o = function(t) {
                ...
                return __extends(e, t),
                    e.prototype.initData = function() {
                        ...
                        var t = this.parent.getChildByName("bottomPanel");
                        this.btnBack = t.getChildByName("btnBack"),
                            this.btnPlay = t.getChildByName("btnPlay");
                        var e = this.parent.getChildByName("score");
                        this.fontScore = e.getChildByName("fontScore"),
                            this.fontScore.value = n["default"].commonData.newScore;

                        this.lblScore = e.getChildByName("lblScore"),
                            this.lblScore.text = platform.getInstance().getStorageSync("MaxScore");

                        var appList = this.parent.getChildByName("appLite").getChildByName("appList");
                        ...
                        if(window.ysdk){
                            ...
                            .then(lb => {
                                // Without extraData
                                lb.setLeaderboardScore('bike', platform.getInstance().getStorageSync("MaxScore"));
                            });
                    ...
                    e.prototype.initEvent = function() {
                        ...
                        !isAfterTime() && ShowInter();  
                        platform.getInstance().showInterstitial(() => {
                            this.parent.close(), n["default"].glEvent.event("init_game_event", {
                                    isPlay: !1
                                }),
                                n["default"].glEvent.event("play_game_event");
                        })
        ...
        var a = t("./BaseView"),
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    this.parent.close(), n["default"].commonData.isNoAds = !1, n["default"].adMgr.showBannerAd();
                }, e;
            }(a["default"]);
        i["default"] = o;
    }, {
        ...
        var a = t("./BaseView"),
            ...
            h = function(t) {
                ...
                return __extends(e, t), e.prototype.initData = function() {
                    ...
                    var t = this.parent.getChildByName("topPanel");
                    this.lbSpeed = t.getChildByName("lbSpeed"), this.lbSpeed.text = "0km/h", this.lbLevel = t.getChildByName("lbLevel"),
                        this.lbLevel.text = "0档", this.barSpeed = t.getChildByName("barSpeed"), this.barSpeed.value = 0,
                        this.barSpeed.visible = !1, this.fontScore = t.getChildByName("fontScore"), this.fontScore.value = "0",
                        this.circle = this.parent.getChildByName("circle"), this.circle.alpha = 0, this.fontCircleNum = this.circle.getChildByName("fontCircleNum"),
                        this.fontAddScore = this.circle.getChildByName("fontAddScore"), this.guidePanel = this.parent.getChildByName("guidePanel"),
                        this.sprGuide = this.guidePanel.getChildByName("sprGuide"), n["default"].tweenMgr.toPosition(this.sprGuide, {
                            x: 569,
                            y: 1075
                        }, 1e3, !0), this.imgGuide = this.guidePanel.getChildByName("imgGuide"), this.imgGuideRotate = this.parent.getChildByName("imgGuideRotate"),
                    ...
                    return n["default"].commonData.isShowSkin ? void Laya.Scene.open("views/freeSkin.scene", !1) : void(n["default"].gameMgr.isPlay || (n["default"].commonData.gameCount++,
        ...
        var a = t("./BaseView"),
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                        ...
                        var t = this.parent._children[0];//getChild("topPanel"),
                            e = this.parent._children[1];//getChild("bottomui");
                        this.btnSound = this.parent._children[0]._children[1];//getChild("btnSound", t), 
                        this.setSound(n["default"].storageMgr.isPlaySound()),
                            this.btnPlay = this.parent._children[1]._children[0];//getChild("btnPlay", e),


                            this.lblScore = this.parent._children[1]._children[2],
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                    ...
                    this._loadNum++, this._loadNum >= this._loadCount && (this.barPres.value = 1, this.lblPres.text = "100%",
                        ...
                        Laya.SoundManager.useMusicAudio = false;
                    ...
                    ShowInter();
                    var t = this;
                    Laya.Scene.open("views/game.scene", false, Laya.Handler.create(t, function(e) {
                        n["default"].commonData.isNoAds = !0, Laya.Scene.open("views/home.scene", false, Laya.Handler.create(t, function(e) {
                            t.close();
                        }));
                    }));
                }, e;
        ...
        var a = t("./BaseView"),
            ...
            o = function(t) {
                ...
                return __extends(e, t), e.prototype.onAwake = function() {
                        ...
                        var t = this.parent.getChildByName("goonTime");
                        this.lbTimer = t.getChildByName("lbTimer"), this.lbTimer.text = this.overTime.toString(),
                            this.btnVideo = this.parent.getChildByName("btnVideo");
                        var e = this.parent.getChildByName("bottomPanel");
                        this.btnSkip = e.getChildByName("btnSkip");
                    }, e.prototype.initEvent = function() {
                        ...
                        n["default"].adMgr.hideBannerAd(), Laya.Scene.open("views/clearing.scene", !1, Laya.Handler.create(this, function(e) {
                            t.sprMask.destroy(), t.bar1.destroy(), t.parent.close();
                        }));
                    },
                    ...
                    e.prototype.onVideoCloseEvent = function(t) {
                        t.isEnded ? (this.parent.close(), this.goonGame()) : (n["default"].wxMgr.showToast("", 2e3),
                            this.isStartTimer = !0);
                    }, e.prototype.goonGame = function() {
                        n["default"].glEvent.event("goon_game_event");
                    }, e.prototype.initProcess = function() {
                        var t = this.parent.getChildByName("goonTime");
                        this.bar1 = t.getChildByName("bar1"), this.sprMask = this.bar1.mask, this.angle = 0,
    ...
    38: [function(t, e, i) {
        ...
        var a = t("../uiComp/skinItem"),
            ...
            s = function(t) {
                ...
                }, e.prototype.resizeView = function() {
                    this.width = Laya.stage.width;
                },
                e.prototype.initUI = function() {
                    ...
                    this.btnVideo = this.getChild("btnVideo", e), this.btnVideo.visible = !0,
                    ...
                    var self = this;
                    ShowRewarded(()=>{
                        n["default"].glEvent.event("change_skin_event", {
                    ...
                    this.itemIndex = 1 + Math.floor(3 * Math.random());
                    var self = this;
                    ShowRewarded(()=>{
                        n["default"].glEvent.event("change_skin_event", {
                            index: self.itemIndex,
                    ...
                    this.itemIndex = 0, n["default"].glEvent.event("change_skin_event", {
                        ...
                        isPlay: !0
                    }), n["default"].commonData.isNoAds = !0, this.close();
                    ...
                    n["default"].storageMgr.setSkinTips(!t);
                }, e;
            }(o["default"]);
        i["default"] = s;
    }, {
